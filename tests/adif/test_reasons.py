...
def test_report_invalid_label_multifield():
    imput = '<call:6>EA4HFF<band:3>40m<EOR><call:5>EA4AW<band:3>40m<EOR><:4>EC5A<band:3>40m<EOR>'
...
def test_report_invalid_size_multifield():
    imput = '<call:6>EA4HFF<band:3>40m<EOR><call:x>EA4AW<band:3>40m<EOR><call:4>EC5A<band:3>40m<EOR>'
...
def test_report_invalid_type_multifield():
    imput = '<call:6:8>EA4HFF<band:3>40m<EOR><call:5>EA4AW<band:3>40m<EOR><call:4>EC5A<band:3>40m<EOR>'
...
def test_report_exceedent_value_multifield():
    imput = '<call:6>EA4HFF tha best<band:3>40m<EOR><call:5>EA4AW<band:3>40m<EOR><call:4>EC5A<band:3>40m<EOR>'
